...
| 配置加载 | `src/config.py` | 环境变量/配置文件加载，374 项参数（configuration 正文 227 + 附录 A 147，与 configuration 一致） |
