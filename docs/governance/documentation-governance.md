...
| 外部理念吸收提案编号（AP-01~37） | [analysis/external-videos/absorption-proposals.md](../analysis/external-videos/absorption-proposals.md)（analysis 目录，非权威） | AP-两位数（吸收提案编号，非权威声明；权威引用以机制名 + 架构 § 章节 表述） |
