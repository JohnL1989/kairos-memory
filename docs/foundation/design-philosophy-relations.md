...
例 1: 价值独立性公理 → S-14 语境自指禁令 → 见证锚定/使用权重双副本分离 → [architecture-v0.1.0.md](architecture-v0.1.0.md) §5.5 差异检验
例 2: 辞典式排序 → 六级链+身份面否决权为宪法级约束 → [architecture-v0.1.0.md](architecture-v0.1.0.md) §3.3 辞典式裁决器 → [architecture-v0.1.0.md](architecture-v0.1.0.md) §3.3 序数幅度差记录 + 运行期漂移审计
例 3: 分域真理观 → 三域三真理路由规则 → [architecture-v0.1.0.md](architecture-v0.1.0.md) §3.2.1 真理路由器（分域真理路由）→ 域切换条件判定 + 跨域默认项选择（决策 D-01）
